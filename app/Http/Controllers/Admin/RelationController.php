    ...
    */
    ...
    public function anyData(){
        ...
        return \DataTables::of($getData->get())->addColumn('editAction', function ($relation) {
            return '<a data-toggle="modal" data-target="#modal-right" href="' . route('relations.edit', ['id' => encrypt($relation->id)]) . '" class="btn edit_name mr-2"><i data-success-callback="relationsEditSuccess" data-error-callback="relationsDeleteError" class="fa fa-edit"></i></a>&nbsp;&nbsp&nbsp;&nbsp;<a href="' . route('relations.destroy', ['id' => encrypt($relation->id)]) .'"  data-success-callback="relationsDeleteSuccess" name= "relation" data-error-callback="relationsSaveError" class="confirm-delete edit_name" ><i class="fa fa-trash"></i></a>';
